<html><head>
    ...
    *{
    ...
    <body style="text-align: center;">
        ...
        <h1 style="font-size: 40px;color: #2f2884;margin-top: 70px;">Dr. {{ $doctor->doctorname }}</h1>  
        ...
        <img src="banner_midas.jpg" style="position:absolute;left:0;top:0;z-index:-1;height:100%;margin:auto;width:100%;" alt="banner_midas">
    </body></html>    